...
namespace fgseg {
	...
	public:
		...
		void avsa_single_gaussian(double alpha);
		void Morpholody_Open(int elmtSize);// this function is used to apply morphological opening on the foreground object
